...
bool createShaderProgram()
{
	...
	const GLchar vsh[] =
		...
		"layout(location = 1) in vec2 a_tp;"
		""
		"out vec2 v_tp;"
		""
		"void main()"
	...
	const GLchar fsh[] =
		...
		"void main()"
		"{"
		"	float color = 5.0 * sin(2.5 * sqrt(pow(40.0 * v_tp.x, 2.0) + pow(30.0 * v_tp.y, 2.0)));"
		"   o_color = vec4(color, 0.0, 0.0, 0.0);"
		"}"
		;
...
bool initOpenGL()
{
	...
	// Create window.
	g_window = glfwCreateWindow(800, 600, "Circles", NULL, NULL);
	if (g_window == NULL)
	{
